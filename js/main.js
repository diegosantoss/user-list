  ...
  window.addEventListener("DOMContentLoaded", function() {
    ...
    function createRow(data) {
      var rowContent =
        ...
        "</td>" +
        '<td class="col">' +
        '<button type="button" class="btn btn-default mr-1 edit-user" id="' +
        data.id +
        '">' +
        '<i class="fas fa-pencil-alt"></i>' +
        "</button>" +
        '<button type="button" class="btn btn-default remove-user" id="' +
        data.id +
        '">' +
    ...
    function createRowEdit(data) {
      var rowContent =
        ...
        "</td>" +
        '<td class="col">' +
        '<button type="submit" class="btn btn-default update-user" id="' +
        data.id +
        '">' +
